(function () {
	...
	var BioteaBioschemasAnnotations =
	/*#__PURE__*/
	function (_HTMLElement) {
	  inherits(BioteaBioschemasAnnotations, _HTMLElement);

	  function BioteaBioschemasAnnotations() {
	    var _this;

	    classCallCheck(this, BioteaBioschemasAnnotations);

	    _this = possibleConstructorReturn(this, getPrototypeOf(BioteaBioschemasAnnotations).call(this));
	    _this._convertedData = {};
	    _this._data = undefined;
	    return _this;
	  }

	  createClass(BioteaBioschemasAnnotations, [{
	    key: "getData",
	    ...
	    key: "_parseAnnotations",
	    value: function _parseAnnotations(text, data) {
	      var _this2 = this;

	      data.forEach(function (d) {
	        d.text = text.substring(d.span.begin, d.span.end);
	      });
	      data = groupBy(data, 'text');
	      this._convertedData.hasPart = [];

	      forEach(data, function (value, key) {
	        _this2._convertedData.hasPart.push(_this2._createAnnotation(value, key));
	      });
	    }
	  }, {
	    key: "_createAnnotation",
	    value: function _createAnnotation(annText, text) {
	      var _this3 = this;
	    ...
	    key: "_createOntoTerm",
	    value: function _createOntoTerm(term) {
	      var myOntoTerm = clone(ontoTerm, true);
